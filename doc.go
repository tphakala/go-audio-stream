...
// subpackages (rtsp and httpsource) and deliver these types; RTP payload
// depacketizers live under depacket. It also defines Source, the source-agnostic capture
