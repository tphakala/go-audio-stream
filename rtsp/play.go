...
// unparseable header is ignored, leaving the first-packet baseline. The
// seed is published atomically because the reader may already be delivering
// early frames on the caller's goroutine.
